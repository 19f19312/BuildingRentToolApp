...
public class UserDeleteAccount extends AppCompatActivity {
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()) {
                                                    ...
                                                    Toast.makeText(UserDeleteAccount.this, "Account Deleted", Toast.LENGTH_LONG).show();
                                                    SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREFS, MODE_PRIVATE);
                                                    SharedPreferences.Editor editor= sharedPreferences.edit();
                                                    editor.clear();
                                                    editor.commit();
                                                    firebaseAuth.signOut();
                                                    startActivity(new Intent(UserDeleteAccount.this, UserTYpe.class));
                                                    finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(UserDeleteAccount.this, UserHome.class));
        finish();
    }
}