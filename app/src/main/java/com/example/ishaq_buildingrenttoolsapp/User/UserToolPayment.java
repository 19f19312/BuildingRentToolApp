...
public class UserToolPayment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_tool_payment);

        radioGroup= (RadioGroup) findViewById(R.id.radioGroup1);
        confirm= (Button) findViewById(R.id.confirm1);
        btn_cal= (Button) findViewById(R.id.btn_cal1);
        ...
        us_address= (EditText) findViewById(R.id.renter_Address1);
        us_name= (EditText) findViewById(R.id.renter_name1);
        us_days= (EditText) findViewById(R.id.renter_days1);
        us_phone= (EditText) findViewById(R.id.renter_phone1);
        here= (TextView) findViewById(R.id.here1);
        btn_cal= (Button) findViewById(R.id.btn_cal1);
        cal_price= (TextView) findViewById(R.id.cal_price1);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (!snapshot.exists()){
                    Toast.makeText(UserToolPayment.this, "", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(UserToolPayment.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (text.equals("Cash on delivery")) {
                    if (validate1()) {
                        ...
                        Toast.makeText(UserToolPayment.this, "Tool Rented Successfully", Toast.LENGTH_LONG).show();
                        Toast.makeText(UserToolPayment.this, "Tool will be delivered to you today", Toast.LENGTH_LONG).show();
                        startActivity(new Intent(UserToolPayment.this, UserHome.class));
                        finish();
                    }
                } else {
    ...
    public void onBackPressed() {
        startActivity(new Intent(UserToolPayment.this, UserRentTool.class));
        finish();
    }
}