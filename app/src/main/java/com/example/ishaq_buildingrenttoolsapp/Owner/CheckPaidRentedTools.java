...
public class CheckPaidRentedTools extends AppCompatActivity {
    private RecyclerView mRecyclerView;
    private ImageAdpaterCheckPaidRentedToos mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_paid_rented_tools);
        ...
        mAdapter = new ImageAdpaterCheckPaidRentedToos(CheckPaidRentedTools.this, mUploads);
        ...
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                    for (DataSnapshot ds : postSnapshot.child("paid").getChildren()) {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(CheckPaidRentedTools.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                mProgressCircle.setVisibility(View.INVISIBLE);
            }
        });
    }
    ...
    public void onBackPressed() {
        startActivity(new Intent(CheckPaidRentedTools.this, OwnerHome.class));
        finish();
    }
}