...
public class WorkerReturnTool extends AppCompatActivity implements ImageAdapterWorkerReturnTool.OnItemClickListener{
    private RecyclerView mRecyclerView;
    private ImageAdapterWorkerReturnTool mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_worker_return_tool);
        ...
        mAdapter = new ImageAdapterWorkerReturnTool(WorkerReturnTool.this, mUploads);
        mRecyclerView.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(WorkerReturnTool.this);
        ...
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(WorkerReturnTool.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                mProgressCircle.setVisibility(View.INVISIBLE);
            }
        });
    }
    ...
    public void onBackPressed() {
        startActivity(new Intent(WorkerReturnTool.this, WorkerHome.class));
        finish();
    }
        ...
        alertDialog.setPositiveButton("Yes",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(WorkerReturnTool.this, "Tool is Returned", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(WorkerReturnTool.this, WorkerHome.class));
                        finish();
                    }
                });
