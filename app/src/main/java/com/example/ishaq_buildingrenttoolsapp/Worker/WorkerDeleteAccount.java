...
public class WorkerDeleteAccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_worker_delete_account);
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()) {
                                                    ...
                                                    Toast.makeText(WorkerDeleteAccount.this, "Account Deleted", Toast.LENGTH_LONG).show();
                                                    SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREFS, MODE_PRIVATE);
                                                    SharedPreferences.Editor editor= sharedPreferences.edit();
                                                    editor.clear();
                                                    editor.commit();
                                                    firebaseAuth.signOut();
                                                    startActivity(new Intent(WorkerDeleteAccount.this, UserTYpe.class));
                                                    finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(WorkerDeleteAccount.this, WorkerHome.class));
        finish();
    }
}