...
public class WorkerViewTool extends AppCompatActivity {
    private RecyclerView mRecyclerView;
    private ImageAdapterWorkerViewTool mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_worker_view_tool);
        ...
        mAdapter = new ImageAdapterWorkerViewTool(WorkerViewTool.this, mUploads);
        ...
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(WorkerViewTool.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                mProgressCircle.setVisibility(View.INVISIBLE);
            }
        });
    }
    ...
    public void onBackPressed() {
        startActivity(new Intent(WorkerViewTool.this, WorkerHome.class));
        finish();
    }
}